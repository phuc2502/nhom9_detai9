...
<section class="tn-amenities-section">
    ...
    [
        ...
        'featured' => false,
        'desc'     => 'Wifi tốc độ cao phủ sóng toàn bộ khu vực khách sạn, đảm bảo kết nối ổn định cho làm việc, giải trí và liên lạc suốt hành trình lưu trú.',
    ],
    [
        'name'     => 'Điều hòa',
        'icon'     => 'fa-solid fa-snowflake',
        'featured' => true,
        'desc'     => 'Hệ thống điều hòa không khí trung tâm hiện đại, tự động điều chỉnh nhiệt độ lý tưởng, mang lại không gian mát mẻ dễ chịu quanh năm.',
    ],
    [
        'name'     => 'TV',
        'icon'     => 'fa-solid fa-tv',
        'featured' => false,
        'desc'     => 'TV màn hình phẳng cỡ lớn với đa dạng kênh trong nước và quốc tế, hỗ trợ phát trực tuyến, phim HD và thể thao trực tiếp.',
    ],
    [
        'name'     => 'Minibar',
        'icon'     => 'fa-solid fa-champagne-glasses',
        'featured' => false,
        'desc'     => 'Minibar được trang bị đầy đủ đồ uống, nước giải khát và đồ ăn nhẹ cao cấp, sẵn sàng phục vụ ngay trong phòng mọi lúc bạn cần.',
    ],
    [
        'name'     => 'Ban công/View biển',
        'icon'     => 'fa-solid fa-water',
        'featured' => true,
        'desc'     => 'Ban công riêng rộng rãi với tầm nhìn trực diện ra biển, nơi lý tưởng để thư giãn, đón gió và ngắm hoàng hôn tuyệt đẹp mỗi ngày.',
    ],
    [
        'name'     => 'Bồn tắm',
        'icon'     => 'fa-solid fa-bath',
        'featured' => false,
        'desc'     => 'Bồn tắm độc lập kích thước lớn, thiết kế sang trọng, cùng hệ thống nước nóng ổn định giúp bạn thư giãn trọn vẹn sau mỗi ngày khám phá.',
    ],
    [
        'name'     => 'Bàn làm việc',
        'icon'     => 'fa-solid fa-briefcase',
        'featured' => false,
        'desc'     => 'Góc làm việc riêng biệt được trang bị bàn rộng, ghế công thái học và đèn chiếu sáng chuyên dụng, đáp ứng nhu cầu công tác của khách doanh nhân.',
    ],
    [
        'name'     => 'Phòng khách riêng',
        'icon'     => 'fa-solid fa-couch',
        'featured' => true,
        'desc'     => 'Phòng khách riêng biệt rộng rãi với sofa cao cấp và không gian sinh hoạt thoải mái, lý tưởng cho gia đình hoặc nhóm khách lưu trú dài ngày.',
    ],
    [
        'name'     => 'Hồ bơi',
        'icon'     => 'fa-solid fa-person-swimming',
        'featured' => false,
        'desc'     => 'Hồ bơi ngoài trời view biển thoáng đãng, mở cửa từ 6:00–22:00. Đội ngũ phục vụ tại hồ sẵn sàng mang đến trải nghiệm bơi lội thư thái và an toàn.',
    ],
    [
        'name'     => 'Butler 24/7',
        'icon'     => 'fa-solid fa-bell-concierge',
        'featured' => true,
        'desc'     => 'Dịch vụ butler cá nhân phục vụ 24/7, sẵn sàng đáp ứng mọi yêu cầu từ đặt tour, đặt bàn nhà hàng đến hỗ trợ hành lý và chăm sóc đặc biệt.',
    ],
];
        ?>
